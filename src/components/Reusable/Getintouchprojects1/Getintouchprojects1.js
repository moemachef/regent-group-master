...
import './Getintouchprojects1.css';
import Map from '../Map/Map.js';

class Getintouchprojects1 extends Component {
  constructor() {
    super();
    this.state = {
      name: '',
  ...
  render() {
    ...
    return (
      <section className="contact-section1" id="">
        ...
        <div className="container">
          <div className="row">
            <h1 className={'body-h1 ' + data.classTitle}> {data.newTitle} </h1>{' '}
            ...
            <div className="contact-input col s12 l11 ">
              <div className="contact-input-right1 right col s12 m5">
                <img
                  src="https://res.cloudinary.com/dd5e5iszi/image/upload/v1526026629/extras/fadiiiii-finall.p.png"
                  alt="sales, call center"
                />
              ...
              <div className="contact-input-left left col s12 m7">
                <h5 className={'h5-first ' + data.classTitle}>
                  {' '}
                  {data.getInTouch}{' '}
                </h5>{' '}
                <p className={'p-first ' + data.classTitle}>
                  {' '}
                  {data.getInTouchP}{' '}
                </p>
                <form onSubmit={this.handleSubmit}>
                  ...
                  <div className={'input-field ' + data.classInput}>
                    <div className="row">
                      <p className={'label ' + data.classTitle}>
                        {' '}
                        {data.number}{' '}
                      </p>{' '}
                    </div>{' '}
...
export default Getintouchprojects1;
